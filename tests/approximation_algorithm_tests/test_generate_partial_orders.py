...
from bnsl_algorithms.approximation_algorithm import generate_partial_orders, get_combinations, partition_vertices
...
@pytest.mark.parametrize("l, k", [(1, 2), (1, 3), (2, 5)])
def test_partial_orders_size(l: int, k: int):
